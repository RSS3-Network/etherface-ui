...
const Text = () => {
  ...
  const fetcherTextEndpoint = async (query: string, page: number) => {
    ...
    let response = await axios.get(
      `/v1/signatures/text/${queryKind}/${query}/${page}`,
      {
              ...
              <Alert
                ...
                infoMessage={
                  <div className="flex flex-col text-left">
                    <span>Some tips:</span>
                    <span>
                      - Searches are case sensitive yielding signatures starting
                      with your query
                    </span>
                    <span>
                      - To narrow down your search to signature names only, end
                      your query with <code>(</code>, e.g.{" "}
                      <code>balanceOf(</code>
                    </span>
                    <span>
                    ...
                    <span className="ml-4">
                      ...
                      <code>f#balanceOf</code>
                    </span>
                    <span className="ml-4">
                      - <code>e#</code> to find events only, e.g.{" "}
                      <code>e#Transfer</code>
                    </span>
                    <span className="ml-4">
