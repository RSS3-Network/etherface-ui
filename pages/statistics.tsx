        ...
        {items && (
          <div className="mt-4 col-start-3 col-end-7">
            ...
            <div className="mt-4 gap-x-8 gap-y-2 grid grid-cols-2 2xl:grid-cols-4">
              <Card
                title={<span># Unique Signatures</span>}
                stat={items.statistics_various_signature_counts.signature_count}
              />
              <Card
                title={
                  <span>
                ...
                stat={
                  items.statistics_various_signature_counts
                    .signature_count_github
                }
              />
              <Card
                title={
            ...
            <div className="w-full h-72 text-center mt-8">
              <ResponsiveContainer width="100%" height="80%">
                <AreaChart
                  data={items.statistics_signature_insert_rate}
            ...
            <div className="text-center">
              <div className="mt-1 text-gray-500 overflow-x-auto relative border rounded mb-8">
                <table className="w-full text-sm text-left text-gray-500">
                  ...
                  <tbody>
                    {items.statistics_signatures_popular_on_github.map(
                      (item, idx) => (
                        <tr
                          key={item.text}
